...
bool downcast_call(Object &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case chatReportReasonCustom::ID:
      ...
      return true;
    case chatStatistics::ID:
      func(static_cast<chatStatistics &>(obj));
      return true;
    case chatStatisticsMessageInteractionCounters::ID:
      func(static_cast<chatStatisticsMessageInteractionCounters &>(obj));
      return true;
...
bool downcast_call(Function &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case getChatStatistics::ID:
      ...
      return true;
    case getChatStatisticsGraph::ID:
      func(static_cast<getChatStatisticsGraph &>(obj));
      return true;
